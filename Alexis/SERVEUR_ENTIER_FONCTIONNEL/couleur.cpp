...
void couleur::setCouleurProjo(EnttecDMXUSB *interfaceDMX, Socket *mySocket, DMX *projo, json_value *value, int valeurDMX[])
{
...
void couleur::setCouleurLyre(EnttecDMXUSB *interfaceDMX, Socket *mySocket, DMX *lyre, json_value *value, int valeurDMX[])
{
	json_value* vConfig = fichierJSON::ouvrirJSON("config.json");
